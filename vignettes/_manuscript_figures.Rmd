...
flow_fsp_plot <- pair_info %>% 
  ...
  geom_point() + geom_smooth(method='lm', col = 'grey50') + scale_x_log10() +
  labs(x = 'Mean patient flow', y = 'Fsp') + 
...
flow_snv_plot <- pair_info %>% 
  ...
  geom_point() + geom_smooth(method='lm', col = 'grey50') + scale_x_log10() +
  labs(x = 'Mean patient flow', y = '# closely related\npairs (≤ 10 SNVs)') + 
...
flow_min_snv_plot <- pair_info %>%
  ...
  geom_point() + geom_smooth(method='lm', col = 'grey50') + scale_x_log10() +
  labs(x = 'Mean patient flow', y = 'Minimum pairwise \nSNV distance') +
...
# tiff('manuscript_figures/Fig9.tiff', width = 12, height = 12, units='in', res=600)
