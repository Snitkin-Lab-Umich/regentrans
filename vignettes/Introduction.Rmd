...
One way to determine whether fsp values are significant is to use permutation ([Donker et al., 2017](mgen.microbiologyresearch.org/pubmed/content/journal/mgen/10.1099/mgen.0.000113)). A faster version of the Fsp calculation is available [here](https://github.com/nateosher/RPTfast), which we recommend for permutation analysis. 
...
For increased efficiency use the optional `locs` argument, a vector of location names of interest. 
