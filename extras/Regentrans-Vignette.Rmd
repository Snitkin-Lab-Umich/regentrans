...
head(facil_coord)
```
We can combine this data with our `locs` data and the Fsp data to creat a geographic map where dot size represents number of isolates collected from a facility and line width represents Fsp value (population similarity between facilities).
